document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('btnLogin').addEventListener('click', () => window.location.href = 'DangNhap_DangKy/login.html');
    document.getElementById('btnRegister').addEventListener('click', () => window.location.href = 'DangNhap_DangKy/register.html');
